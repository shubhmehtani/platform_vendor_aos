...
source_tree="AOS/"; #path here must be inside home directory
changelog_path_name=vendor/aos/CHANGELOG.md #changelog file path/name.extension
source_name="Atomic-OS" #Name to display in changelog.md top before version
# input variables end
...
echo ""
echo >> $Changelog;
echo "# $source_name Version 1.0 Changelog"    >> $Changelog;
echo '====================================================' >> $Changelog;
echo >> $Changelog;
